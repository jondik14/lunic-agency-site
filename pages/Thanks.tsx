  ...
  return (
    <Section background="stone" className="min-h-[70vh] flex items-center justify-center text-center">
      <div className="max-w-lg">
        ...
        <h1 className="font-serif font-bold text-4xl md:text-5xl text-studio-ink mb-6">Thanks - I'll review this and email you shortly with suggestions.</h1>
        <p className="text-lg text-studio-muted mb-8 leading-relaxed">
          I'll take a look at your website and business context, then follow up with specific suggestions or next steps. No pressure, no obligation.
        </p>
